...
author = "Matthew Price, Louise Mousset, Erwan Allys, and Jason McEwen"
...
html_theme_options = {
    ...
    "navbar_align": "left",
    "announcement": "s2scat is currently under development",
    "show_toc_level": 2,
    "show_nav_level": 1,
    ...
    "icon_links": [
        ...
        {
            "name": "CodeCov",
            "url": "https://app.codecov.io/gh/astro-informatics/s2scat",
...
latex_documents = [
    (
        master_doc,
        "S2SCAT.tex",
        "S2SCAT Documentation",
        "Matthew Price, Louise Mousset, Erwan Allys, and Jason McEwen",
        "manual",
    ),
]
...
man_pages = [(master_doc, "s2scat", "S2SCAT Documentation", [author], 1)]
